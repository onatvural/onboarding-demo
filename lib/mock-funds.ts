...
export const mockFunds: FundDetail[] = [
  // Düşük Risk Fonları
  {
    id: 'ykp-kisa-vadeli-tahvil',
    ad: 'YKP Kısa Vadeli Tahvil Fonu',
    risk: 'Düşük Risk',
    getiri: 8.5,
    minimumTutar: 1000,
    kategori: 'Tahvil',
  ...
  // Orta Risk Fonları
  {
    id: 'ykp-dengeli-karma',
    ad: 'YKP Dengeli Karma Fon',
    risk: 'Orta Risk',
    getiri: 12.5,
    minimumTutar: 1500,
    kategori: 'Karma',
  ...
  {
    id: 'ykp-baslangic-fon-sepeti',
    ad: 'YKP Başlangıç Fon Sepeti',
    risk: 'Orta Risk',
    getiri: 11.8,
    minimumTutar: 1000,
    kategori: 'Fon Sepeti',
  ...
  // Yüksek Risk Fonları
  {
    id: 'ykp-hisse-senedi-fon',
    ad: 'YKP Hisse Senedi Fonu',
    risk: 'Yüksek Risk',
    getiri: 18.7,
    minimumTutar: 3000,
  ...
  {
    id: 'ykp-teknoloji-yogun',
    ad: 'YKP Teknoloji Yoğun Fon',
    risk: 'Yüksek Risk',
    getiri: 22.4,
    minimumTutar: 5000,
    kategori: 'Sektörel',
  ...
  {
    id: 'ykp-gelisen-piyasalar',
    ad: 'YKP Gelişen Piyasalar Fonu',
    risk: 'Yüksek Risk',
    getiri: 20.1,
    minimumTutar: 4000,
  ...
  // Tematik Fonlar
  {
    id: 'ykp-surdurulebilirlik-temali',
    ad: 'YKP Sürdürülebilirlik Temalı Fon',
    risk: 'Orta Risk',
    getiri: 13.9,
    minimumTutar: 2500,
    kategori: 'Tematik',
  ...
  {
    id: 'ykp-teknoloji-inovasyon',
    ad: 'YKP Teknoloji ve İnovasyon Fonu',
    risk: 'Yüksek Risk',
    getiri: 24.2,
    minimumTutar: 5000,
    kategori: 'Tematik',
